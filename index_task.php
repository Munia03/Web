		...
		<ul class="items">
			<?php foreach($items as $item): ?>
				<li>
					...
					<?php if(!$item['done']) : ?>
					<a href="mark.php?as=done&item=<?php echo $item['id']; ?>" style="background:#7FB3D5">Mark as done</a>
					
					<?php endif; ?>
					<a href="index_comment.php?as=done&item=<?php echo $item['id']; ?>" style="background:#7FB3D5">Comment</a>
				</li>
			<?php endforeach; ?>
